...
db.candidateFeedbackInfo= require("./candidate_feedback_info.model.js")
...
db.candidateJoiningDetails= require("./candidate_joining_details.model.js")
...
db.candidateExperience.belongsTo(db.candidateJoiningDetails);
db.candidateCTC.belongsTo(db.candidateDetails);
db.candidateFeedbackInfo.belongsTo(db.candidateDetails);
